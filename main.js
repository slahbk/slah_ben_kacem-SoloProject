function generateID() {
      ...
      var values = Object.values(ele1)
        each(values, function(ele2, i){ // to search for string
          if(typeof(ele2) == 'string'){
            var words = ele2.split(' ') // maybe the string have more than one word so we split it
  ...
  bikeShop.add('CANYON Speedmax CFR Disc Di2', 11999,'Bikes',['https://file.removal.ai/preview/be93360a-b936-4f43-8bc7-3b17a2e57418-full_2022_speedmax-cfr-disc-di2_2921_bu-bk_p5.png','https://file.removal.ai/preview/7c0602a6-b707-4d25-9f17-0857cda4d512-2921_top-1_speedmax-cfr-disc-di2_bu-bk_cockpit.png','https://www.canyon.com/dw/image/v2/BCML_PRD/on/demandware.static/-/Sites-canyon-master/default/dwa9b38eb8/images/top/2921_TOP-4/2022/2921_TOP-4_speedmax-cfr-disc-di2_bu-bk_fork-disc.jpg?sw=1300&sh=1300&sm=cut&sfrm=jpg&q=80'])
