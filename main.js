function generateID() {
  ...
  function makeSomething(Name, Price, Category, Images) { // factory function
    var i = 0
  ...
  var remove = function(id){
    this.list = filter(this.list, function(ele, i){
      return ele.id !== id
    })
  }
  ...
  function displayAll(array){ // display all in the shop list
    ...
    $('#home').on(click, function(){displayAll(bikeShop.list)})
